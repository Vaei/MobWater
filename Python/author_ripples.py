...
def build_render_targets():
    """The pair the field lives in."""
    built = []

    for name in (TARGET_NAME, HISTORY_NAME):
        ...
        target.set_editor_property('render_target_format', FIELD_FORMAT)
        ...
        target.set_editor_property('clear_color', unreal.LinearColor(0.5, 0.5, 0.0, 1.0))
